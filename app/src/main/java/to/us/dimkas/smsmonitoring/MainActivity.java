...
//		this.getListView().setDividerHeight(2);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (cursor != null) {
			...
			final String ULstr = "W**254030101*9991*BB0000000200500040010000BB0000000054540214021502155427037F00005737090400011762860000004000000000000000000000000000000040XX";
            UL ul = new UL(ULstr);
			AlertDialog.Builder builder = new AlertDialog.Builder(this);
			builder.setMessage(ul.toString())
				.setCancelable(true);
